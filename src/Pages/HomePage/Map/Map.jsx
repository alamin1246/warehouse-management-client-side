                ...
                <div className="flex flex-wrap pt-12 lg:pt-0">
                  <div className="mb-12 grow-0 shrink-0 basis-auto w-full md:w-6/12 lg:w-full xl:w-6/12 px-3 md:px-6 xl:px-12">
                    <div className="flex items-start">
                      <div className="shrink-0">
                        <div className="p-4 bg-green-600 rounded-md shadow-md w-14 h-14 flex items-center justify-center">
                          <svg
                            aria-hidden="true"
                            focusable="false"
                            data-prefix="fas"
                      ...
                      <div className="grow ml-6">
                        <h4 className="text-xl">Technical support</h4>
                  ...
                  <div className="mb-12 grow-0 shrink-0 basis-auto w-full md:w-6/12 lg:w-full xl:w-6/12 px-3 md:px-6 xl:px-12">
                    <div className="flex items-start">
                      ...
                      <div className="grow ml-6">
                       <h4 className="text-xl">Stock questions</h4>
                  ...
                  <div className="mb-12 grow-0 shrink-0 basis-auto w-full md:w-6/12 lg:w-full xl:w-6/12 px-3 md:px-6 xl:px-12">
                    <div className="flex align-start">
                      ...
                      <div className="grow ml-6">
                       <h4 className="text-xl">Daily Policy</h4>
                  ...
                  <div className="mb-12 lg:mb-0 grow-0 shrink-0 basis-auto w-full md:w-6/12 lg:w-full xl:w-6/12 px-3 md:px-6 xl:px-12">
                    <div className="flex align-start">
                      ...
                      <div className="grow ml-6">
                       <h4 className="text-xl">Bug report</h4>
