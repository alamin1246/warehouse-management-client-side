...
const Header = () => {
  ...
  return (
    <>
      <div className=" py-2 md:py-4 bg-blue-800 shadow-xl text-black z-10">
        <div className="container px-4  lg:px-4  mx-auto lg:flex lg:items-center">
          ...
          <nav
            className={`flex gap-6 md:ml-auto  justify-between lg:justify-end items-center absolute w-full lg:static flex-col lg:flex-row transition delay-200 ease-in-out  z-10 bg-blue-800 ${
          ...
          >
            <NavLink
              ...
              className={({ isActive }) =>
                isActive
                  ? "p-2 lg:px-4 md:mx-2 text-white rounded hover:bg-blue-200 hover:text-black-500 bg-teal-600"
                  : "p-2 lg:px-4 md:mx-2 text-white rounded hover:bg-blue-200 hover:text-black-500 "
              }
            >
              Home
            </NavLink>
