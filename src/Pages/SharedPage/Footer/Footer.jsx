...
const Footer = () => {
  return (
    <>
      <div className="footer-2 bg-blue-800 pt-6 md:pt-12 z-10">
        ...
        <div className="border-t border-solid border-blue-900 mt-4 py-4">
          <div className="container px-4 mx-auto">
            <div className="md:flex md:-mx-4 md:items-center">
              <div className="md:flex-1 md:px-4 text-center md:text-left">
                <p className="text-white">
                  &copy; Md. Al Amin Hossain
                  <strong>
                    <span className="text-green-400"> Kids Toys Stock Management </span>2022
                  </strong>
                </p>
              </div>
