...
import google from '../../../images/SocialImg/google.png';
import facebook from '../../../images/SocialImg/facebook.png';
import github from '../../../images/SocialImg/github.png';
        ...
        <div>
            ...
            <div className=''>
                <button onClick={() => signInWithGoogle()} className='btn btn-primary w-50 d-block mx-auto my-2'>
                    ...
                    <span className='px-2'> Sign With Google</span>
                </button>
