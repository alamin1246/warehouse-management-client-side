...
const ManageInventory = () => {
    ...
    const loadData = async () => {
      try {
        const { data } = await axios.get(
          `https://cryptic-cliffs-97574.herokuapp.com/all-inventory-items`
        );
  ...
  return (
    <>
      <div className="w-full min-h-screen px-1 bg-gray-100 my-5 md:my-10">
        <div className="max-w-7xl hidden md:block mx-auto sm:px-6 lg:px-8">
